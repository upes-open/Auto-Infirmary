                          ...
                          child: Column(
                            children: [
                             ...
                             /*ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemBuilder: (context, count) {
                                  if(doctor_list.length<=userStream2.docs.length-1){
                                  doctor_list.insert(count, (userStream2.docs[count].get("Name")));
                                  }
...
builder: (c,s){
  return  ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemBuilder: (context, count) {
                                  if(doctor_list.length<=s.data.docs.length)
                                  {
                                
                                    if(count<=doctor_list.length-1)
                                    {
                                   doctor_list.removeAt(count);
                                    }
                                    
                                      n= s.data.docs[count].data()['Name'];
                                    
                                doctor_list.insert(count, n);
                                print(doctor_list);
                                  }
